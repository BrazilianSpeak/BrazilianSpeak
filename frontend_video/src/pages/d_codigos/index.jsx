...
export function ParticipantView(props) {
  ...
  return (
    <div key={props.participantId}>
      <p>
        Participant: {displayName} | Webcam: {webcamOn ? "ativo" : "desativado"} | Mic:{" "}
        {micOn ? "ativo" : "desativado"}
      </p>
...
export function Controls() {
  ...
  return (
    <div>
      <button onClick={() => leave()}>Sair da reunião</button><br />
      <button onClick={() => toggleMic()}>Ativar / desativar microfone</button><br />
      <button onClick={() => toggleWebcam()}>Ativar / desativar Webcam</button><br />
    </div>
  );
}
